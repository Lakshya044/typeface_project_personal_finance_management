        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
          <div className="text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link 
                href="/dashboard" 
                className="bg-gray-700 hover:bg-gray-600 text-white font-semibold py-3 px-8 rounded-lg transition-colors duration-200 inline-flex items-center justify-center"
              >
                <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-gray-800 border border-gray-700 rounded-xl p-6">
            ...
            <h3 className="text-xl font-semibold text-white mb-2">Transaction Management</h3>
          ...
          <div className="bg-gray-800 border border-gray-700 rounded-xl p-6">
            ...
            <h3 className="text-xl font-semibold text-white mb-2">Receipt Extraction</h3>
          ...
          <div className="bg-gray-800 border border-gray-700 rounded-xl p-6">
            ...
            <h3 className="text-xl font-semibold text-white mb-2">Budget vs Actual</h3>
      ...
      <div className="bg-gradient-to-r from-blue-900 to-purple-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="text-center">
            ...
            <Link 
              href="/addTransaction" 
              className="bg-white text-blue-900 font-semibold py-3 px-8 rounded-lg hover:bg-gray-100 transition-colors duration-200 inline-flex items-center"
            >
              Get Started
      ...
      <footer className="bg-gray-900 border-t border-gray-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="text-center text-gray-400">
            <p>&copy; 2024 Personal Finance App. Track your financial journey.</p>
          </div>
        </div>
      </footer>
    </div>
